"""/status — thin wrapper re-dispatching to lobster/bot/telegram.py handler.

Phase 1 just re-uses the v3 TelegramBot._cmd_status. A future gateway
