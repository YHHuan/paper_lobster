...
async def post_init(application):
    ...
    from lobster.explorer.search import TavilySearch
    from lobster.explorer.rss import RSSReader
    from lobster.explorer.reader import JinaReader
    from lobster.explorer.x_listener import XListener
    from lobster.explorer.academic import AcademicSearch
    from lobster.explorer.browser import HeadlessBrowser
    from lobster.explorer.pdf_reader import PDFReader
    from lobster.explorer.forage import Forager
    from lobster.agent_logic.evolution import EvolutionEngine
    from lobster.agent_logic.evolve import Evolver
    from lobster.agent_logic.lobster import Lobster
    from lobster.agent_logic.mirror import Mirror
